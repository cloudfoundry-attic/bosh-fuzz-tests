...
type FakeStep struct {
	RunStub        func(clirunner.Runner) error
	runMutex       sync.RWMutex
	runArgsForCall []struct {
		arg1 clirunner.Runner
	}
	runReturns struct {
		result1 error
	}
...
func (fake *FakeStep) Run(arg1 clirunner.Runner) error {
	fake.runMutex.Lock()
...
func (fake *FakeStep) RunArgsForCall(i int) clirunner.Runner {
	fake.runMutex.RLock()
	defer fake.runMutex.RUnlock()
...
var _ deployment.Step = new(FakeStep)
