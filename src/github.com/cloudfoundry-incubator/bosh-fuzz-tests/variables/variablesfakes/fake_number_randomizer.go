...
type FakeNumberRandomizer struct {
...
func (fake *FakeNumberRandomizer) Intn(n int) int {
	fake.intnMutex.Lock()
...
func (fake *FakeNumberRandomizer) IntnCallCount() int {
	fake.intnMutex.RLock()
	defer fake.intnMutex.RUnlock()
	return len(fake.intnArgsForCall)
}

func (fake *FakeNumberRandomizer) IntnArgsForCall(i int) int {
	fake.intnMutex.RLock()
	defer fake.intnMutex.RUnlock()
	return fake.intnArgsForCall[i].n
}

func (fake *FakeNumberRandomizer) IntnReturns(result1 int) {
	fake.IntnStub = nil
...
func (fake *FakeNumberRandomizer) IntnReturnsOnCall(i int, result1 int) {
	fake.IntnStub = nil
...
func (fake *FakeNumberRandomizer) Invocations() map[string][][]interface{} {
...
func (fake *FakeNumberRandomizer) recordInvocation(key string, args []interface{}) {
...
var _ variables.NumberRandomizer = new(FakeNumberRandomizer)
